...
public class DatabaseSetting extends JDialog {
    ...
    public DatabaseSetting(ShellEntity shellEntity, DbInfo dbInfo2) {
        ...
        this.dbHostTextField = new JTextField(dbInfo2.getDbHost());
        this.dbPortTextField = new JTextField(Integer.toString(dbInfo2.getDbPort()));
        this.dbUserNameTextField = new JTextField(dbInfo2.getDbUserName());
        this.dbPasswordTextField = new JTextField(dbInfo2.getDbPassword());
        ...
        this.dbCharsetComboBox.setSelectedItem(dbInfo2.getCharset().toString());
        this.dbTypeComboBox.setEditable(false);
        this.dbTypeComboBox.setSelectedItem(dbInfo2.getDbType());
    ...
    private void updateButtonClick(ActionEvent actionEvent) {
        try {
            ...
            if (dbType.trim().length() > 0) {
                ...
                this.dbInfo.setCharset(Encoding.getEncoding(this.dbCharsetComboBox.getSelectedItem().toString()));
